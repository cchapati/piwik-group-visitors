 ...
 */
class GetGroupVisitors extends Base
{
    protected function init()
    {
        ...
        // $this->menuTitle    = 'GroupVisitorsName';
        ...
        // $this->widgetTitle  = 'GroupVisitorsName';
    }
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        $view->config->columns_to_display = array('label', 'nb_visits');// array_merge(array('label'), $this->metrics);
    }
    ...
    {
        $view = new View('@GroupVisitors/getGroupVisitors');
        $view->myData = array();
